...
public interface ITranslator {
	...
	// text (i.e. the words to be translated), builds up the translated text a word at a time, and sets the field for
	// the translated word. (This is a mutator for the field referencing the translated text.
	void consultLookup();
}
